...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = eventsFunctionContext.getOnceTriggers().triggerOnce(9834356);
}
}
if (isConditionTrue_0) {
...
/* Reuse gdjs.evtsExt__Toolbar__UpdateToolSelection.GDButtonObjects1 */
{for(var i = 0, len = gdjs.evtsExt__Toolbar__UpdateToolSelection.GDButtonObjects1.length ;i < len;++i) {
    gdjs.evtsExt__Toolbar__UpdateToolSelection.GDButtonObjects1[i].getBehavior(eventsFunctionContext.getBehaviorName("Effect")).enableEffect("Black", false);
}
}{for(var i = 0, len = gdjs.evtsExt__Toolbar__UpdateToolSelection.GDButtonObjects1.length ;i < len;++i) {
    gdjs.evtsExt__Toolbar__UpdateToolSelection.GDButtonObjects1[i].getBehavior(eventsFunctionContext.getBehaviorName("Effect")).enableEffect("White", true);
}
}}
...
/* Reuse gdjs.evtsExt__Toolbar__UpdateToolSelection.GDButtonObjects1 */
{for(var i = 0, len = gdjs.evtsExt__Toolbar__UpdateToolSelection.GDButtonObjects1.length ;i < len;++i) {
    gdjs.evtsExt__Toolbar__UpdateToolSelection.GDButtonObjects1[i].getBehavior(eventsFunctionContext.getBehaviorName("Effect")).enableEffect("Black", true);
}
}{for(var i = 0, len = gdjs.evtsExt__Toolbar__UpdateToolSelection.GDButtonObjects1.length ;i < len;++i) {
    gdjs.evtsExt__Toolbar__UpdateToolSelection.GDButtonObjects1[i].getBehavior(eventsFunctionContext.getBehaviorName("Effect")).enableEffect("White", false);
}
}}
...
gdjs.evtsExt__Toolbar__UpdateToolSelection.func = function(runtimeScene, Button, Effect, parentEventsFunctionContext) {
